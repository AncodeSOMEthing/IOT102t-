...
/* Notes:
    ...
    - UID của RFID mặc định: 53915227
...
const String UIDMaster = "53915227";
String secondUID;
...
void loop() {
  ...
  // **Thay đổi chức năng nút resetPassPin**
  if (digitalRead(resetPassPin) == LOW) {
    accessDoor(); // Thay resetPass() bằng accessDoor()
    delay(1000);  // Tránh trường hợp nút bấm bị kích hoạt liên tục
  }
}
